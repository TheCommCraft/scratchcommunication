...
try:
    ...
    browsercookie = None  # ty:ignore[invalid-assignment]
    browsercookie_err = e
...
class Session(Sessionable):
    ...
    def __init__(
        ...
        *,
        ...
        if (
            isinstance(username_or_sessionable, Sessionable)
            or hasattr(username_or_sessionable, "session_string")
        ) or isinstance(username_or_sessionable, bytes):
            if isinstance(username_or_sessionable, Sessionable) or hasattr(
                username_or_sessionable, "session_string"
            ):
        ...
        *,
        ...
        try:
            ...
            if self.username is None:
                raise LoginFailure(
                    "No username supplied and there was none found. The username is needed."
                ) from None
    ...
    def create_turbowarp_cloudconnection(
        ...
        return cloud.TwCloudConnection(
            project_id=project_id, username=username or "player1000", session=self, **kwargs
        )
    ...
    def create_cloud_socket(
        ...
        *,
        ...
        cloudconnection_kwargs: Optional[dict] = None,
        ...
        **kwargs,
        ...
        """
        return cloud_socket.CloudSocket(
            cloud=self.create_cloudconnection(
                project_id,
                warning_type=ErrorInCloudSocket,
                allow_no_certificate=allow_no_certificate,
                **(cloudconnection_kwargs if cloudconnection_kwargs else {}),
            ),
    ...
    def create_turbowarp_cloud_socket(
        self,
        project_id: str,
        contact_info: str,
        *,
        ...
        **kwargs,
        ...
        """
        return cloud_socket.CloudSocket(
            cloud=self.create_tw_cloudconnection(
                project_id,
